            ...
            <div className="container mx-auto px-4 lg:px-8">
              <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-8">
                  <div>
                    <h2 className="text-base sm:text-lg font-bold text-foreground mb-3">Step 1: Download the Kabukabu App</h2>
                  ...
                  <div>
                    <h2 className="text-base sm:text-lg font-bold text-foreground mb-3">Step 2: Open the App and Sign Up</h2>
                    <ul className="list-disc pl-5 sm:pl-6 space-y-2 text-muted-foreground">
                  ...
                  <div>
                    <h2 className="text-base sm:text-lg font-bold text-foreground mb-3">Step 3: Verify Your Information</h2>
                    <ul className="list-disc pl-5 sm:pl-6 space-y-2 text-muted-foreground">
                  ...
                  <div>
                    <h2 className="text-base sm:text-lg font-bold text-foreground mb-3">Step 4: Start Booking Rides</h2>
                    <ul className="list-disc pl-5 sm:pl-6 space-y-2 text-muted-foreground">
                  ...
                  <div>
                    <h2 className="text-base sm:text-lg font-bold text-foreground mb-3">Step 5: Customize Your Profile</h2>
                    <ul className="list-disc pl-5 sm:pl-6 space-y-2 text-muted-foreground">
