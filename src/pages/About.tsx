            ...
            <div className="mx-auto w-full max-w-[1720px]">
              ...
              <div className="relative overflow-hidden">
                ...
                <div
                  ...
                  className="relative z-10 flex snap-x snap-mandatory gap-4 overflow-x-auto px-[4%] py-6 sm:px-[5%] sm:py-8 lg:px-[7%] [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
                >
                  {setsUsApartSlides.map((slide) => (
                    ...
                    >
                      <div className="grid min-h-[300px] grid-cols-1 md:min-h-[340px] md:grid-cols-[1.02fr_1fr] lg:min-h-[380px] lg:grid-cols-[1.08fr_1fr]">
                        <img
                          src={slide.image}
                          alt={slide.alt}
                          className="h-[180px] w-full object-cover sm:h-[220px] md:h-full"
                          loading="lazy"
                        />
