    ...
    <section id="drive" className="py-12 sm:py-16 lg:py-28 bg-header">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">
          {/* Content */}
          <div>
            <h2 className="text-sectionTitle font-bold text-white mb-6">
              Drive with Kabukabu
            </h2>
            <p className="text-white/80 text-bodyLg mb-8">
            ...
            <div className="space-y-6 mb-10">
              {benefits.map((benefit) => (
                <div key={benefit.title} className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-cardTitle text-white font-semibold mb-1">
                      {benefit.title}
                    </h3>
            ...
            <Button 
              size="lg"
              className="bg-primary hover:bg-primary/90 text-primary-foreground font-semibold px-8 sm:px-10 py-5 sm:py-6 text-body rounded-lg"
            >
              Become a Driver
            </Button>
          </div>
