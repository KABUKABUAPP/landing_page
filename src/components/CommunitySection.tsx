    ...
    <section className="py-12 sm:py-16 lg:py-28 bg-background">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="mb-10 sm:mb-16">
          <div 
            className="aspect-[4/3] sm:aspect-[21/9] rounded-xl sm:rounded-2xl bg-cover bg-center"
            style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="bg-cream rounded-2xl p-6 sm:p-8">
            <div className="flex flex-col lg:flex-row items-center gap-6">
              <div className="bg-white rounded-3xl shadow-lg p-3 w-28 sm:w-36 lg:w-40 flex-shrink-0">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-3">
                  <a href="#" className="inline-block">
                    <div className="bg-foreground text-background px-3 sm:px-4 py-2 rounded-lg flex items-center gap-2">
