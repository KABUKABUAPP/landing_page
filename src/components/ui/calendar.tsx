    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ? "text-body"
            : "flex h-8 items-center gap-1 rounded-md pl-2 pr-1 text-body [&>svg]:size-3.5 [&>svg]:text-muted-foreground",
